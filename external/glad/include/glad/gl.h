/**
 * Loader generated by glad 2.0.8 on Wed Dec 24 10:02:33 2025
 *
 ...
 *
 * Commandline:
 *    --api='gl:compatibility=4.6' --extensions='GL_AMD_framebuffer_multisample_advanced,GL_AMD_framebuffer_sample_positions,GL_AMD_gpu_shader_half_float,GL_AMD_gpu_shader_int16,GL_AMD_gpu_shader_int64,GL_AMD_shader_image_load_store_lod,GL_AMD_shader_stencil_export,GL_APPLE_float_pixels,GL_APPLE_flush_buffer_range,GL_APPLE_rgb_422,GL_APPLE_ycbcr_422,GL_ARB_ES2_compatibility,GL_ARB_ES3_1_compatibility,GL_ARB_ES3_2_compatibility,GL_ARB_ES3_compatibility,GL_ARB_buffer_storage,GL_ARB_compressed_texture_pixel_storage,GL_ARB_fragment_program,GL_ARB_fragment_shader,GL_ARB_fragment_shader_interlock,GL_ARB_framebuffer_no_attachments,GL_ARB_framebuffer_object,GL_ARB_framebuffer_sRGB,GL_ARB_geometry_shader4,GL_ARB_gl_spirv,GL_ARB_half_float_pixel,GL_ARB_half_float_vertex,GL_ARB_pixel_buffer_object,GL_ARB_shader_texture_image_samples,GL_ARB_shader_texture_lod,GL_ARB_shader_viewport_layer_array,GL_ARB_shading_language_420pack,GL_ARB_shadow,GL_ARB_sparse_texture,GL_ARB_sparse_texture2,GL_ARB_sparse_texture_clamp,GL_ARB_spirv_extensions,GL_ARB_sync,GL_ARB_texture_barrier,GL_ARB_texture_compression,GL_ARB_texture_filter_anisotropic,GL_ARB_texture_float,GL_ARB_texture_rectangle,GL_ARB_texture_rg,GL_ARB_texture_rgb10_a2ui,GL_ARB_texture_stencil8,GL_ARB_texture_storage_multisample,GL_ARB_vertex_program,GL_ARB_vertex_shader,GL_ARB_vertex_type_10f_11f_11f_rev,GL_ARB_vertex_type_2_10_10_10_rev,GL_ARB_viewport_array,GL_EXT_422_pixels,GL_EXT_abgr,GL_EXT_bgra,GL_EXT_blend_color,GL_EXT_depth_bounds_test,GL_EXT_gpu_shader4,GL_EXT_texture,GL_EXT_texture3D,GL_EXT_texture_array,GL_EXT_texture_buffer_object,GL_EXT_texture_compression_s3tc,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_storage,GL_EXT_texture_swizzle,GL_EXT_vertex_array,GL_EXT_vertex_shader,GL_KHR_texture_compression_astc_hdr,GL_KHR_texture_compression_astc_ldr,GL_KHR_texture_compression_astc_sliced_3d,GL_OES_byte_coordinates,GL_OES_compressed_paletted_texture,GL_OES_fixed_point,GL_S3_s3tc,GL_SGIX_depth_texture' c
 *
 * Online:
