...
static std::map<SceGxmColorFormat, std::pair<GLenum, GLenum>> GXM_COLOR_FORMAT_TO_GL_FORMAT = {
    { SCE_GXM_COLOR_FORMAT_U8U8U8U8_ABGR, { GL_RGBA, GL_UNSIGNED_INT } },
    { SCE_GXM_COLOR_FORMAT_U8U8U8U8_ARGB, { GL_UNSIGNED_INT } },
    { SCE_GXM_COLOR_FORMAT_U8U8U8U8_RGBA, { GL_RGBA, GL_UNSIGNED_BYTE } },
    { SCE_GXM_COLOR_FORMAT_U4U4U4U4_ARGB, { GL_UNSIGNED_SHORT_4_4_4_4 } },
    ...
    { SCE_GXM_COLOR_FORMAT_U10U10U10U2_RGBA, { GL_UNSIGNED_INT_2_10_10_10_REV } },
    ...
    { SCE_GXM_COLOR_FORMAT_F16F16F16F16_ARGB, { GL_UNSIGNED_SHORT } },
    ...
    { SCE_GXM_COLOR_FORMAT_SE5M9M9M9_RGB, { GL_HALF_FLOAT } }
};
#else
static std::map<SceGxmColorFormat, std::pair<GLenum, GLenum>> GXM_COLOR_FORMAT_TO_GL_FORMAT = {
